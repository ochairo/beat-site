...
const ICON_MAP: Record<string, BeatJsxChild> = {
  reactivity: <IconBeatReactivity color={ICON_COLOR} />,
  "direct-dom": <IconBeatDirectDom color={ICON_COLOR} />,
  router: <IconBeatRouter color={ICON_COLOR} />,
  resource: <IconBeatResource color={ICON_COLOR} />,
  typescript: <IconBeatTypeScript color={ICON_COLOR} />,
  "run-once": <IconBeatRunOnce color={ICON_COLOR} />,
};
      ...
      <section class={css["hero"]!}>
        <div class={css["heroLeft"]!}>
          ...
          <p class={css["description"]!}>
            Direct-DOM rendering with fine-grained reactivity. Explicit routing
            and async primitives. No virtual DOM.
          </p>
